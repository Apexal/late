            ...
            <div class="column is-half">
              <div class="field">
                ...
                <div class="control">
                  <select
                    id="course-id"
                    :placeholder="assignment.courceCRN"
                    name="course_crn"
                    class="input"
                  >
                    <option
...
export default {
  ...
  methods: {
    ...
    async save () {
      this.loading = true;
      // TODO: error handle
      const request = await API.post(`/assignments/a/${this.assignmentID}/edit`);


      // Calls API and updates state
      // await this.$store.dispatch(
      //   'EDIT_ASSIGNMENT',
      //   request.data.editedAssignment
      // );
      ...
      // // Notify user
      // this.$store.commit('ADD_NOTIFICATION', { type: 'success', description: `Edited assignment '${request.data.createdAssignment.title}' due ${moment(this.due_date + ' ' + this.time, 'YYYY-MM-DD HH:mm').fromNow()}.` });
    }
  }
};
</script>

<template>
  <div class="about">
    <h1 class="is-size-2 page-header">About Us</h1>
    <div class="columns">
      <section class="section">
        <div id="goal">
          <div class="content column is-two-third">
            <h1 class="title is-4">The Goal</h1>
...
.page-header {
    ...
    position: absolute; //I'M SORRY
    width: 100%;
    left: 0px;
    text-align: center;
}
//Pads out about section to fit in the space better
.about .section {
